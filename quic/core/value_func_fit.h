...
#ifndef NET_QUIC_CORE_VALUE_FUNC_FIT_H_
#define NET_QUIC_CORE_VALUE_FUNC_FIT_H_
...
class QUIC_EXPORT_PRIVATE ValueFuncFit : public ValueFunc {
 public:
  ValueFuncFit();
  ValueFuncFit(const string& filename);
