...
#ifndef NET_QUIC_CORE_CONGESTION_CONTROL_MAX_PROP_RISK_H_
#define NET_QUIC_CORE_CONGESTION_CONTROL_MAX_PROP_RISK_H_
...
namespace test {
class MaxPropRiskPeer;
}  // namespace test

class QUIC_EXPORT_PRIVATE MaxPropRisk : public TcpCubicSenderBase {
 public:
  MaxPropRisk(const QuicClock* clock,
                      const RttStats* rtt_stats,
                      bool reno,
                      QuicPacketCount initial_tcp_congestion_window,
                      QuicPacketCount max_congestion_window,
                      QuicConnectionStats* stats);
  ~MaxPropRisk() override;
...
#endif  // NET_QUIC_CORE_CONGESTION_CONTROL_MAX_PROP_RISK_H_
