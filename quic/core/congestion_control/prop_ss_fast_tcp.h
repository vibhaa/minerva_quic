...
#ifndef NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_FAST_TCP_H_
#define NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_FAST_TCP_H_
...
namespace test {
class PropSSFastTcpPeer;
}  // namespace test

class QUIC_EXPORT_PRIVATE PropSSFastTcp : public TcpCubicSenderBase {
 public:
  PropSSFastTcp(const QuicClock* clock,
 ...
 private:
  friend class test::PropSSFastTcpPeer;
...
#endif  // NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_FAST_TCP_H_
