...
#ifndef NET_QUIC_CORE_CONGESTION_CONTROL_NUM_SENDER_H_
#define NET_QUIC_CORE_CONGESTION_CONTROL_NUM_SENDER_H_
...
class QUIC_EXPORT_PRIVATE NumSender : public TcpCubicSenderBase {
 public:
  NumSender(const QuicClock* clock,
 ...
 private:
  friend class test::NumSenderPeer;
  ...
  DISALLOW_COPY_AND_ASSIGN(NumSender);
};

}  // namespace net

#endif  // NET_QUIC_CORE_CONGESTION_CONTROL_NUM_SENDER_H_
