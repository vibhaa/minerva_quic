...
#ifndef NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_BBR_SENDER_H_
#define NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_BBR_SENDER_H_
...
// PropSSBbrSender implements BBR congestion control algorithm.  BBR aims to estimate
...
class QUIC_EXPORT_PRIVATE PropSSBbrSender : public SendAlgorithmInterface {
 public:
  enum Mode {
  ...
  // control issues.
  struct DebugState {
    explicit DebugState(const PropSSBbrSender& sender);
  ...
  PropSSBbrSender(const QuicClock* clock, const RttStats* rtt_stats,
            const QuicUnackedPacketMap* unacked_packets,
            QuicPacketCount initial_tcp_congestion_window,
            QuicPacketCount max_tcp_congestion_window,
            QuicRandom* random);
  ~PropSSBbrSender() override;
 ...
 private:
  ...
  // Wrapper for accessing the pacing gain array.
  float PacingGainAtOffset(int offset) const;
  ...
  DISALLOW_COPY_AND_ASSIGN(PropSSBbrSender);
};

QUIC_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os,
                                             const PropSSBbrSender::Mode& mode);
QUIC_EXPORT_PRIVATE std::ostream& operator<<(
    std::ostream& os,
    const PropSSBbrSender::DebugState& state);

}  // namespace net

#endif  // NET_QUIC_CORE_CONGESTION_CONTROL_PROP_SS_BBR_SENDER_H_
